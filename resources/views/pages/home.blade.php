...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/hero.webp') }}"
             alt="DXB Exports — Vehículos desde Dubái"
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center pt-24 pb-16">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="https://wa.me/{{ env('WHATSAPP_NUMBER', '971558369427') }}?text=Hola,%20quisiera%20solicitar%20una%20cotización"
               target="_blank"
...
<section class="py-16 bg-[#111111] border-y border-[#1A1A1A]">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <a href="https://wa.me/{{ env('WHATSAPP_NUMBER', '971558369427') }}?text=Hola,%20quisiera%20solicitar%20una%20cotización%20de%20vehículo"
           target="_blank"
